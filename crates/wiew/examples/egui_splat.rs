...
use wiew::{
    ...
    provided::{
        ...
        pipelines::{FlatPipeline, LitMaterial, LitPipeline, SplatPipeline},
    },
    view::View3d,
};
...
impl Scene {
    fn new(_view: &View3d) -> Self {
        ...
        let point_pipeline = SplatPipeline::new();
        let sphere_material = LitMaterial::leios_dark_blue();
        let point_material = LitMaterial::leios_blue().with_point_size(0.018);
        ...
        Self {
            ...
            sphere_pipeline,
            sphere_material,
            point_cloud: simulated_point_cloud(1400 / 5, 1000 / 5),
            point_pipeline,
            point_material,
        }
    }
